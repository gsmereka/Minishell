...
void	init_repl_signals_handling(t_data *g_data);
...
void	format_cmd(t_token *token, t_cmd *cmd, t_data *g_data);
void	get_outputs(t_token *token, t_cmd *cmd, t_data *g_data);
void	get_inputs(t_token *token, t_cmd *cmd, t_data *g_data);
...
int		redirect_input(int cmd, t_data *g_data);
int		redirect_output(int cmd, t_data *g_data);
...
void	ft_echo(char **args, t_data *g_data);
...
// end_program
void	end_program(t_data *g_data);
